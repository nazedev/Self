...
╚═══❏ *SELF-BOT* ❏══❍`
    ...
    case 'ganteng':
					...
					break   
	case 'gatal':
                    const gatal = fs.readFileSync('gatal.mp3')
                    naze.sendMessage(from, sound12, MessageType.audio, {quoted: naze, mimetype: 'audio/mp4', ptt:true})
                    break
    case 'kontag':
