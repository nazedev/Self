...
╚═══❏ *SELF-BOT* ❏══❍`
    ...
    case 'get':
            ...
            break
    case 'asalamualaikum':
		if (!q) return reply('Waalaikumsalam')
                    break
    case 'cantik':
					if (!q) return reply('Iya kamu Cantik😘')
					const cantik = fs.readFileSync('./mp3/cantik.mp3')
                    naze.sendMessage(from, cantik, MessageType.audio, {quoted: naze, mimetype: 'audio/mp4', ptt:true})
					break    
    case 'halo':
					if (!q) return reply('Halo juga👋')
					break
    case 'ganteng':
					if (!q) return reply('Iya lu Ganteng🗿')
					const ganteng = fs.readFileSync('./mp3/ganteng.mp3')
                    naze.sendMessage(from, ganteng, MessageType.audio, {quoted: naze, mimetype: 'audio/mp4', ptt:true})
					break   
	case 'gatal':
                    const gatal = fs.readFileSync('./mp3/gatal.mp3')
                    naze.sendMessage(from, gatal, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
                    break
    case 'admin':
                    if (!q) return reply('Apa?🤨')
                    const admin = fs.readFileSync('./mp3/admin.mp3')
                    naze.sendMessage(from, admin, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
                    break          
    case 'menu':
                    const menu = fs.readFileSync('./mp3/menu.mp3')
                    naze.sendMessage(from, menu, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
                    break 
    case 'kontag':
    ...
    case 'tomp3':
            ...
            hexa.sendMessage(from, buffer453, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
            fs.unlinkSync(ran)
            })
            break
    case 'fast':
