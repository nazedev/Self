...
╚═══❏ *NAZE - SELF* ❏══❍`
	...
	case 'ytmp3':
      ...
      case 'pap':
              ...
              bilan = fs.readFileSync('./mp3/sound12.mp3');
      ...
      case 'didunia':
              if (!isRegistered) return reply(ind.noregis())
              if (isLimit(sender)) return reply(ind.limitend(pusname))
              bilan = fs.readFileSync('./mp3/didunia.mp3');
              naze.sendMessage(from, bilan, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
              await limitAdd(sender)
              break
      case 'welot':
              if (!isRegistered) return reply(ind.noregis())
              if (isLimit(sender)) return reply(ind.limitend(pusname))
              bilan = fs.readFileSync('./mp3/welot.mp3');
              naze.sendMessage(from, bilan, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
              await limitAdd(sender)
              break
      case 'barabere':
              if (!isRegistered) return reply(ind.noregis())
              if (isLimit(sender)) return reply(ind.limitend(pusname))
              bilan = fs.readFileSync('./mp3/barabere.mp3');
              naze.sendMessage(from, bilan, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
              await limitAdd(sender)
              break
      case 'fyp':
              if (!isRegistered) return reply(ind.noregis())
              if (isLimit(sender)) return reply(ind.limitend(pusname))
              bilan = fs.readFileSync('./mp3/fyp.mp3');
              naze.sendMessage(from, bilan, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
              await limitAdd(sender)
              break
      case 'myfather':
              if (!isRegistered) return reply(ind.noregis())
              if (isLimit(sender)) return reply(ind.limitend(pusname))
              bilan = fs.readFileSync('./mp3/myfather.mp3');
              naze.sendMessage(from, bilan, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
              await limitAdd(sender)
              break
      case 'ladadida':
              if (!isRegistered) return reply(ind.noregis())
              if (isLimit(sender)) return reply(ind.limitend(pusname))
              bilan = fs.readFileSync('./mp3/ladadida.mp3');
              naze.sendMessage(from, bilan, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
              await limitAdd(sender)
              break
    case 'image':
