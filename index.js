// SC NYA JANGAN DI JUAL NGENTOD GUA CAPE RAKITNYA
//MAKASIH DAH PAKE 
const
	{
		WAConnection,
...
❏ *SELF-BOT* ❏`
    ...
    case 'tomp3':
            ...
            naze.sendMessage(from, buffer453, MessageType.audio, { mimetype: 'audio/mp4', quoted: mek })
            fs.unlinkSync(ran)
            })
            break
    case 'fast':
   ...
   case 'hidetag':
      ...
      case 'play':
                    ...
                    naze.sendMessage(from, buffer, image, { quoted: mek, caption: ini_txt })
                    get_audio = await getBuffer(get_result.audio[3].link)
                    naze.sendMessage(from, get_audio, MessageType.audio, { mimetype: 'audio/mp4', filename: `${get_info.title}.mp3`, quoted: mek })
                    break
        case 'video':
